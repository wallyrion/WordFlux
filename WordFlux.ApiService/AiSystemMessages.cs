...
public static class AiSystemMessages
{
    ...
    public const string exampleResponseJson = """
                                              ...
                                              {"term":"лук (для стрельбы)", "list":[{"tr":"bow","e_tr":"He practices with his *bow* every weekend","e_or":"Он практикуется с луком каждые выходные", "u_f": 90}]}
                                              """;
    ...
    public const string RequestForAssistantWithArguments = $$$"""
                                                               ...
                                                               9. there can be a note inside 'term' that should be considered as a clue for the context.
                                                               """;
